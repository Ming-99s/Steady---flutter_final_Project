...
class Highlightcard extends StatelessWidget {
  const Highlightcard({super.key,required this.habit,required this.type,required this.icon,required this.title});
  final Habit habit;
  ...
  Widget build(BuildContext context) {
    HabitProgress habitProgress =  dailyProgressRepo.calculateHabitProgress(habit.habitId,habit.scheduleIndices);
        ...
        child: Row(
          ...
          children: [
            Column(
              ...
              children: [
                SizedBox(height: 30,),
                Text('$value',style: TextStyle(fontSize: 30,color: AppColors.textPrimary,fontWeight: FontWeight.w800),),
